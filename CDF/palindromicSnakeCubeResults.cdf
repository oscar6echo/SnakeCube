...
NotebookDataLength[     10764,        258]
NotebookOptionsPosition[     11015,        246]
NotebookOutlinePosition[     11530,        270]
CellTagsIndexPosition[     11487,        267]
WindowTitle->Palindromic Snake Cubes
WindowFrame->Normal*)
  ...
  StyleBox[
   DynamicModuleBox[{$CellContext`k$$ = 1, $CellContext`nbS$$ = 
    ...
    "\"untitled\"", Typeset`specs$$ = {{
      Hold[
       Text[
        Style["Palindromic Snake Cube Solutions\n", 14, Bold]]], 
      Manipulate`Dump`ThisIsNotAControl}, {{
       Hold[$CellContext`nbS$$], 5, "Number of S in Snake Cube Sequence"}, 0, 
      13, 1}, {{
       Hold[$CellContext`nbSol$$], 7, "Number of Solutions to Snake"}, 1, 45, 
      1}, {{
...
$CellContext`selection$ = 
         Select[$CellContext`basePathsLVPalind, And[StringCount[
...
'Number of S' and 'Number of Solutions'", 14, Bold, Red]]]], "Specifications" :> {
        Text[
         Style[
         "Palindromic Snake Cube Solutions\n", 14, 
          Bold]], {{$CellContext`nbS$$, 5, 
          "Number of S in Snake Cube Sequence"}, 0, 13, 1, Appearance -> 
         "Labeled"}, {{$CellContext`nbSol$$, 7, 
          "Number of Solutions to Snake"}, 1, 45, 1, Appearance -> 
...
$CellContext`outputGraph]; $CellContext`detSnakeV[
       ...
       Block[{$CellContext`snakeV = 
         ...
         Graphics[
          ...
          18, ImageSize -> 500]]; $CellContext`resultsPalind = 
       Import["https://github.com/oscar6echo/SnakeCube/raw/master/Tables/\
resultsPalind.csv"]; $CellContext`basePathsLVPalindimport = 
       Map[ToExpression, 
         Import[
         "https://github.com/oscar6echo/SnakeCube/raw/master/Tables/\
basePathsLVPalind.csv"], 2]; $CellContext`nbSnakesPalind = 
       Length[$CellContext`basePathsLVPalindimport]; \
$CellContext`nbBasePathsPalind = Table[
         Length[
          
          Part[$CellContext`basePathsLVPalindimport, $CellContext`s]], \
{$CellContext`s, $CellContext`nbSnakesPalind}]; \
$CellContext`basePathsLVPalind = Table[{
          ToString[
...
$CellContext`b, 1]], 
          ...
          Part[$CellContext`basePathsLVPalindimport, $CellContext`s, \
$CellContext`b, 
           2]}, {$CellContext`s, $CellContext`nbSnakesPalind}, \
{$CellContext`b, 
          Part[$CellContext`nbBasePathsPalind, $CellContext`s]}]; Null); 
...
(*NotebookFileOutline
Notebook[{
Cell[1272, 31, 9739, 213, 1008, InheritFromParent]
}
]
*)
